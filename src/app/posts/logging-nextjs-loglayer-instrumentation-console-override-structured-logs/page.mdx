...
export const meta = {
  ...
  tags: ['Next.js', 'Observability', 'Logging', 'LogLayer', 'Pino', 'Edge Runtime'],
};
...
First, the file must live in the correct location. Next.js supports placing it at the project root or inside `src/` when your app uses that layout. If it is not found, the override never runs.
