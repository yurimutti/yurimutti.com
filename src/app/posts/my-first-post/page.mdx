...
export const meta = {
  title: 'My Post',
  summary: 'Learn how to create interactive blog posts with MDX and Sandpack. This post demonstrates code syntax highlighting, live code editing, and custom React components integration.',
